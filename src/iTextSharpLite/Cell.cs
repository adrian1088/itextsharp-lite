...
namespace iTextSharp
{
    ...
    /// </code>
    /// </example>
    /// <seealso cref="T:iTextSharp.Rectangle"/>
    /// <seealso cref="T:iTextSharp.Element"/>
    /// <seealso cref="T:iTextSharp.Table"/>
    /// <seealso cref="T:iTextSharp.Row"/>
    public class Cell : Rectangle, ITextElementArray
    {
        ...
        {
            if (Helpers.EqualsIgnoreCase(alignment, ElementTags.ALIGN_CENTER))
            {
                this.HorizontalAlignment = Element.ALIGN_CENTER;
                return;
            }
            if (Helpers.EqualsIgnoreCase(alignment, ElementTags.ALIGN_RIGHT))
            {
                this.HorizontalAlignment = Element.ALIGN_RIGHT;
                return;
            }
            if (Helpers.EqualsIgnoreCase(alignment, ElementTags.ALIGN_JUSTIFIED))
            {
                this.HorizontalAlignment = Element.ALIGN_JUSTIFIED;
                return;
            }
            if (Helpers.EqualsIgnoreCase(alignment, ElementTags.ALIGN_JUSTIFIED_ALL))
            {
        ...
        {
            if (Helpers.EqualsIgnoreCase(alignment, ElementTags.ALIGN_MIDDLE))
            {
                this.VerticalAlignment = Element.ALIGN_MIDDLE;
                return;
            }
            if (Helpers.EqualsIgnoreCase(alignment, ElementTags.ALIGN_BOTTOM))
            {
                this.VerticalAlignment = Element.ALIGN_BOTTOM;
                return;
            }
            if (Helpers.EqualsIgnoreCase(alignment, ElementTags.ALIGN_BASELINE))
            {
