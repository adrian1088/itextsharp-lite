    ...
    public class ElementTags
    {
        ...
        */
        ...
        public static int AlignmentValue(String alignment)
        {
            ...
            if (Helpers.EqualsIgnoreCase(ALIGN_CENTER, alignment))
            {
                return Element.ALIGN_CENTER;
            }
            if (Helpers.EqualsIgnoreCase(ALIGN_LEFT, alignment))
            {
                return Element.ALIGN_LEFT;
            }
            if (Helpers.EqualsIgnoreCase(ALIGN_RIGHT, alignment))
            {
                return Element.ALIGN_RIGHT;
            }
            if (Helpers.EqualsIgnoreCase(ALIGN_JUSTIFIED, alignment))
            {
                return Element.ALIGN_JUSTIFIED;
            }
            if (Helpers.EqualsIgnoreCase(ALIGN_JUSTIFIED_ALL, alignment))
            {
                return Element.ALIGN_JUSTIFIED_ALL;
            }
            if (Helpers.EqualsIgnoreCase(ALIGN_TOP, alignment))
            {
                return Element.ALIGN_TOP;
            }
            if (Helpers.EqualsIgnoreCase(ALIGN_MIDDLE, alignment))
            {
                return Element.ALIGN_MIDDLE;
            }
            if (Helpers.EqualsIgnoreCase(ALIGN_BOTTOM, alignment))
            {
                return Element.ALIGN_BOTTOM;
            }
            if (Helpers.EqualsIgnoreCase(ALIGN_BASELINE, alignment))
            {
