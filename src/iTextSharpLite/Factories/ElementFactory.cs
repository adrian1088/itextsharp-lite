...
namespace iTextSharp.Factories
{
    /**
    ...
    public class ElementFactory
    {
        ...
        */
        ...
        public static Image GetImage(Properties attributes)
        {
            ...
            if (value != null)
            {
                if (Helpers.EqualsIgnoreCase(ElementTags.ALIGN_LEFT, value))
                    align |= Image.ALIGN_LEFT;
                else if (Helpers.EqualsIgnoreCase(ElementTags.ALIGN_RIGHT, value))
                    align |= Image.ALIGN_RIGHT;
                else if (Helpers.EqualsIgnoreCase(ElementTags.ALIGN_MIDDLE, value))
                    align |= Image.ALIGN_MIDDLE;
            }
            if (Helpers.EqualsIgnoreCase("true", attributes[ElementTags.UNDERLYING]))
                align |= Image.UNDERLYING;
            if (Helpers.EqualsIgnoreCase("true", attributes[ElementTags.TEXTWRAP]))
