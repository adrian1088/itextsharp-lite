...
namespace iTextSharp
{
    ...
    public class Font : IComparable
    {
        ...
        */
        ...
        {
            if (Helpers.EqualsIgnoreCase(family, FontFactory.COURIER))
            {
                return COURIER;
            }
            if (Helpers.EqualsIgnoreCase(family, FontFactory.HELVETICA))
            {
                return HELVETICA;
            }
            if (Helpers.EqualsIgnoreCase(family, FontFactory.TIMES_ROMAN))
            {
                return TIMES_ROMAN;
            }
            if (Helpers.EqualsIgnoreCase(family, FontFactory.SYMBOL))
            {
                return SYMBOL;
            }
            if (Helpers.EqualsIgnoreCase(family, FontFactory.ZAPFDINGBATS))
            {
                return ZAPFDINGBATS;
            }
            return UNDEFINED;
