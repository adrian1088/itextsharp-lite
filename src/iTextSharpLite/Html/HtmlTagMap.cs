    ...
    */
    ...
    public class HtmlTagMap : Hashtable
    {
        ...
        */
        ...
        {
            return Helpers.EqualsIgnoreCase(HtmlTags.HTML, tag);
        }
        ...
        */
        ...
        {
            return Helpers.EqualsIgnoreCase(HtmlTags.HEAD, tag);
        }
        ...
        */
        ...
        {
            return Helpers.EqualsIgnoreCase(HtmlTags.META, tag);
        }
        ...
        */
        ...
        {
            return Helpers.EqualsIgnoreCase(HtmlTags.LINK, tag);
        }
        ...
        */
        ...
        {
            return Helpers.EqualsIgnoreCase(HtmlTags.TITLE, tag);
        }
        ...
        */
        ...
        {
            return Helpers.EqualsIgnoreCase(HtmlTags.BODY, tag);
        }
