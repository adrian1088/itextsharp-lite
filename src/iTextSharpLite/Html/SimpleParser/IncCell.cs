...
namespace iTextSharp.Html.SimpleParser
{
    /**
    *
    * @author  psoares
    */
    ...
    public class IncCell : ITextElementArray
    {
        ...
        public IncCell(String tag, ChainedProperties props)
        {
            ...
            if (value != null)
            {
                if (Helpers.EqualsIgnoreCase(value, "center"))
                    cell.HorizontalAlignment = Element.ALIGN_CENTER;
                else if (Helpers.EqualsIgnoreCase(value, "right"))
                    cell.HorizontalAlignment = Element.ALIGN_RIGHT;
                else if (Helpers.EqualsIgnoreCase(value, "left"))
                    cell.HorizontalAlignment = Element.ALIGN_LEFT;
                else if (Helpers.EqualsIgnoreCase(value, "justify"))
            ...
            if (value != null)
            {
                if (Helpers.EqualsIgnoreCase(value, "top"))
                    cell.VerticalAlignment = Element.ALIGN_TOP;
                else if (Helpers.EqualsIgnoreCase(value, "bottom"))
