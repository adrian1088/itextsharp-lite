    ...
    public class AcroFields
    {
        ...
        */
        ...
        public bool SetFieldProperty(String field, String name, Object value, int[] inst)
        {
            ...
            PdfString da;
            if (Helpers.EqualsIgnoreCase(name, "textfont"))
            {
            ...
            else if (Helpers.EqualsIgnoreCase(name, "textcolor"))
            {
                for (int k = 0; k < item.Size; ++k)
                {
                    if (hit.IsHit(k))
            ...
            else if (Helpers.EqualsIgnoreCase(name, "textsize"))
            {
                for (int k = 0; k < item.Size; ++k)
                {
                    if (hit.IsHit(k))
            ...
            else if (Helpers.EqualsIgnoreCase(name, "bgcolor") || Helpers.EqualsIgnoreCase(name, "bordercolor"))
            {
                PdfName dname = (Helpers.EqualsIgnoreCase(name, "bgcolor") ? PdfName.BG : PdfName.BC);
                for (int k = 0; k < item.Size; ++k)
                {
                    if (hit.IsHit(k))
                    {
        ...
        */
        ...
        public bool SetFieldProperty(String field, String name, int value, int[] inst)
        {
            ...
            if (item == null)
                return false;
            InstHit hit = new InstHit(inst);
            if (Helpers.EqualsIgnoreCase(name, "flags"))
            {
            ...
            else if (Helpers.EqualsIgnoreCase(name, "setflags"))
            {
                for (int k = 0; k < item.Size; ++k)
                {
                    if (hit.IsHit(k))
            ...
            else if (Helpers.EqualsIgnoreCase(name, "clrflags"))
            {
                for (int k = 0; k < item.Size; ++k)
                {
                    if (hit.IsHit(k))
            ...
            else if (Helpers.EqualsIgnoreCase(name, "fflags"))
            {
                PdfNumber num = new PdfNumber(value);
                for (int k = 0; k < item.Size; ++k)
                {
            ...
            else if (Helpers.EqualsIgnoreCase(name, "setfflags"))
            {
                for (int k = 0; k < item.Size; ++k)
                {
                    if (hit.IsHit(k))
            ...
            else if (Helpers.EqualsIgnoreCase(name, "clrfflags"))
            {
                for (int k = 0; k < item.Size; ++k)
                {
                    if (hit.IsHit(k))
