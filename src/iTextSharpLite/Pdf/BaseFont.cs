        ...
        */
        ...
        public static Stream GetResourceStream(string key)
        {
            ...
            try
            {
                ...
                resource = assm.GetManifestResourceStream(key);
            }
            catch { }
            ...
            for (int k = 0; k < resourceSearch.Count; ++k)
            {
                ...
                try
                {
                    if (obj is Assembly)
                    {
                        resource = ((Assembly)obj).GetManifestResourceStream(key);
                        if (resource != null)
                            return resource;
                    }
                    else if (obj is string)
                    {
                        ...
                        try
                        {
                            resource = Assembly.LoadFrom(dir).GetManifestResourceStream(key);
                        }
                        catch
                        {
                        }
