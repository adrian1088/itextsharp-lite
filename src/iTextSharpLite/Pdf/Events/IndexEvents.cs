...
namespace iTextSharp.Pdf.Events
{
    /**
    * Class for an index.
    *
        ...
        */
        ...
        private class ISortIndex : IComparer
        {
            public int Compare(object arg0, object arg1)
            {
                ...
                {
                    if ((rt = Helpers.CompareToIgnoreCase(en1.GetIn1(), en2.GetIn1())) == 0)
                    {
                        // in1 equals
                        if (en1.GetIn2() != null && en2.GetIn2() != null)
                        {
                            if ((rt = Helpers.CompareToIgnoreCase(en1.GetIn2(), en2.GetIn2())) == 0)
                            {
                                // in2 equals
                                if (en1.GetIn3() != null && en2.GetIn3() != null)
                                {
                                    rt = Helpers.CompareToIgnoreCase(en1.GetIn3(), en2.GetIn3());
                                }
                            }
                        }
                    }
