        ...
        */
        ...
        public void Rectangle(Rectangle rectangle)
        {
            ...
            else
            {
                ...
                if (rectangle.BorderWidth != iTextSharp.Rectangle.UNDEFINED)
                {
                ...
                if (rectangle.HasBorder(iTextSharp.Rectangle.BOX))
                {
                ...
                {
                    if (rectangle.HasBorder(iTextSharp.Rectangle.RIGHT_BORDER))
                    {
                        MoveTo(x2, y1);
                        LineTo(x2, y2);
                    }
                    if (rectangle.HasBorder(iTextSharp.Rectangle.LEFT_BORDER))
                    {
                        MoveTo(x1, y1);
                        LineTo(x1, y2);
                    }
                    if (rectangle.HasBorder(iTextSharp.Rectangle.BOTTOM_BORDER))
                    {
                        MoveTo(x1, y1);
                        LineTo(x2, y1);
                    }
                    if (rectangle.HasBorder(iTextSharp.Rectangle.TOP_BORDER))
                    {
                        MoveTo(x1, y2);
                        LineTo(x2, y2);
                    }
