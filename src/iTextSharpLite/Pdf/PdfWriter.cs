...
using Internals.Util.Collections;

using iTextSharp.Pdf.Collection;
using iTextSharp.Pdf.Events;
using iTextSharp.Pdf.Interfaces;
using iTextSharp.Pdf.Intern;
using iTextSharp.Xml.Xmp;
        ...
        IPdfAnnotations
    {
        ...
        */
        ...
        public override void Close()
        {
            if (open)
            {
                ...
                body.WriteCrossReferenceTable(os, indirectCatalog.IndirectReference, infoObj.IndirectReference, encryption, fileID, prevxref);
        ...
        */
        ...
        public int PDFXConformance
        {
            set
            {
                if (pdfxConformance.PDFXConformance == value) return;
                if (pdf.IsOpen()) throw new PdfXConformanceException("PDFX conformance can only be set before opening the document.");

                if (value == PDFA1A || value == PDFA1B) PdfVersion = VERSION_1_4;
                else if (value != PDFXNONE) PdfVersion = VERSION_1_3;
