...
using iTextSharp.Rtf.Document.Output;
using iTextSharp.Rtf.HeaderFooter;
using iTextSharp.Rtf.List;
using iTextSharp.Rtf.Style;

using HF = iTextSharp.Rtf.HeaderFooter;
using ST = iTextSharp.Rtf.Style;

//using iTextSharp.Rtf;
/*
...
namespace iTextSharp.Rtf.Document
{
    /**
    ...
    */
    ...
    public class RtfDocumentHeader : RtfElement
    {
        ...
        */
        private iTextSharp.HeaderFooter header = null;
        /**
        * The current RtfHeaderFooterGroup for the footer
        */
        private iTextSharp.HeaderFooter footer = null;
        ...
        */
        ...
        public void SetHeader(iTextSharp.HeaderFooter header)
        {
            this.header = header;
        }
        ...
        */
        ...
        public void SetFooter(iTextSharp.HeaderFooter footer)
        {
            this.footer = footer;
        }
        ...
        */
        ...
        private RtfHeaderFooterGroup ConvertHeaderFooter(iTextSharp.HeaderFooter hf, int type)
        {
            if (hf != null)
            {
