...
namespace iTextSharp.Rtf.HeaderFooter
{
    /**
    ...
    */
    ...
    public class RtfHeaderFooter : iTextSharp.HeaderFooter, IRtfBasicElement
    {
        /**
        ...
        */
        ...
        protected internal RtfHeaderFooter(RtfDocument doc, iTextSharp.HeaderFooter headerFooter, int type, int displayAt) : base(new Phrase(""), false)
        {
            this.document = doc;
            this.type = type;
        ...
        */
        ...
        protected internal RtfHeaderFooter(RtfDocument doc, iTextSharp.HeaderFooter headerFooter) : base(new Phrase(""), false)
        {
            this.document = doc;
            Paragraph par = new Paragraph();
            par.Alignment = headerFooter.Alignment;
        ...
        */
        ...
        public void SetAlignment(int alignment)
        {
            ...
            for (int i = 0; i < this.content.Length; i++)
            {
                ...
                else if (this.content[i] is iTextSharp.Table)
                {
                    ((iTextSharp.Table)this.content[i]).Alignment = alignment;
                }
