...
namespace iTextSharp.Rtf.HeaderFooter
{
    ...
    */
    ...
    public class RtfHeaderFooterGroup : iTextSharp.HeaderFooter, IRtfBasicElement
    {
        /**
        ...
        */
        ...
        public RtfHeaderFooterGroup(RtfDocument doc, iTextSharp.HeaderFooter headerFooter, int type) : base(new Phrase(""), false)
        {
            this.document = doc;
            this.type = type;
            this.mode = MODE_SINGLE;
        ...
        */
        ...
        public void SetHeaderFooter(iTextSharp.HeaderFooter headerFooter, int displayAt)
        {
            this.mode = MODE_MULTIPLE;
            switch (displayAt)
            {
