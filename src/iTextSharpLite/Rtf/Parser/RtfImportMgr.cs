...
namespace iTextSharp.Rtf.Parser
{
    ...
    */
    ...
    public class RtfImportMgr
    {
        ...
        */
        private iTextSharp.Document doc = null;
        ...
        */
        ...
        public RtfImportMgr(RtfDocument rtfDoc, iTextSharp.Document doc)
        {
            this.rtfDoc = rtfDoc;
            this.doc = doc;
        ...
        */
        ...
        public bool ImportStylesheetList(String listNr, iTextSharp.List listIn)
        {
