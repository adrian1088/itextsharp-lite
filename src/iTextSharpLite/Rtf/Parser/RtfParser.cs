...
using iTextSharp.Rtf.Direct;
using iTextSharp.Rtf.Document;
using iTextSharp.Rtf.Parser.CtrlWords;
using iTextSharp.Rtf.Parser.Destinations;
...
namespace iTextSharp.Rtf.Parser
{
    /**
    ...
    */
    ...
    public class RtfParser
    {
        ...
        */
        private iTextSharp.Document document = null;
        /**
        ...
        */
        ...
        public RtfParser(iTextSharp.Document doc)
        {
            this.document = doc;
        }
        ...
        */
        ...
        public void ConvertRtfDocument(Stream readerIn, iTextSharp.Document doc)
        {
        ...
        */
        ...
        private void Init(int type, RtfDocument rtfDoc, Stream readerIn, iTextSharp.Document doc, IElement elem)
        {
            Init_stats();
        ...
        */
        ...
        private void HandleImportMappings(RtfImportMappings importMappings)
        {
            ...
            {
                this.importMgr.ImportStylesheetList(stylesheetListNr, (iTextSharp.List)importMappings.GetStylesheetListMappings()[stylesheetListNr]);
            }
        }
        ...
        */
        ...
        public static void OutputDebug(object doc, int groupLevel, String str)
        {
            ...
            else if (doc is iTextSharp.Document)
            {
                try
                {
                    ((iTextSharp.Document)doc).Add(new RtfDirectContent("\n" + spaces + str));
                }
        ...
        */
        ...
        public iTextSharp.Document GetDocument()
        {
