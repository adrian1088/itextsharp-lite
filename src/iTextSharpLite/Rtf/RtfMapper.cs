...
using iTextSharp.Rtf.Field;
using iTextSharp.Rtf.Graphic;
using iTextSharp.Rtf.List;
using iTextSharp.Rtf.Table;
        ...
        */
        ...
        public IRtfBasicElement[] MapElement(IElement element)
        {
            ...
            switch (element.Type)
            {
                ...
                case Element.LIST:
                    rtfElements.Add(new RtfList(rtfDoc, (iTextSharp.List)element));
                    break;
                ...
                case Element.TABLE:
                    try
                    {
                        rtfElements.Add(new RtfTable(rtfDoc, (iTextSharp.Table)element));
                    }
