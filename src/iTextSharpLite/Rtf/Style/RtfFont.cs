...
namespace iTextSharp.Rtf.Style
{
    /**
    ...
    public class RtfFont : Font, IRtfExtendedElement
    {
        ...
        */
        ...
        public RtfFont(RtfDocument doc, Font font)
        {
            ...
            if (Helpers.EqualsIgnoreCase(this.fontName, "unknown"))
            {
                return;
            }
        ...
        */
        ...
        public override Font Difference(Font font)
        {
            ...
            if (dFamilyname == null || dFamilyname.Trim().Equals("") || Helpers.EqualsIgnoreCase(dFamilyname.Trim(), "unknown"))
            {
